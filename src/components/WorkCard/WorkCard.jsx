              ...
              {(() => {
                ...
                if (/unity/i.test(tech)) {
                  return (
                    <span title="Unity">
                      <img
                        src={process.env.PUBLIC_URL + "/img/icons/unity.png"}
                        alt="Unity icon"
                        width={22}
                        height={22}
                ...
                if (/unreal/i.test(tech)) {
                  return (
                    <span title="Unreal Engine">
                      <img
                        src={process.env.PUBLIC_URL + "/img/icons/unreal.png"}
              ...
              {(() => {
                ...
                if (/unity/i.test(tech)) {
                  return (
                    <span title="Unity">
                      <img
                        src={process.env.PUBLIC_URL + "/img/icons/unity.svg"}
                        alt="Unity icon"
                        width={22}
                        height={22}
                ...
                if (/unreal/i.test(tech)) {
                  return (
                    <span title="Unreal Engine">
                      <img
                        src={process.env.PUBLIC_URL + "/img/icons/unreal.svg"}
                        alt="Unreal Engine icon"
                        width={22}
                        height={22}
                        style={{ display: 'inline-block', verticalAlign: 'middle' }}
